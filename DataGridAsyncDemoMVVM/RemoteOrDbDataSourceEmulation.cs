    ...
    public IList<RemoteOrDbDataItem> FilteredOrderedItems
    {
      get
      {
                ...
                lock (this)
          {
              ...
              try
              {
                  if ( string.IsNullOrWhiteSpace( this.WhereLinqExpression ) && string.IsNullOrWhiteSpace( this.OrderByLinqExpression ) )
                      this._orderedItems.AddRange( this._items );
                  else if ( !string.IsNullOrWhiteSpace( this.WhereLinqExpression ) && string.IsNullOrWhiteSpace( this.OrderByLinqExpression ) )
                      ...
                      this._orderedItems.AddRange( this._items.Where( this.WhereLinqExpression ).OrderBy( this.OrderByLinqExpression ) );
              }
              catch
              {
              }
